    ...
    >
      <div className="container mx-auto max-w-6xl">
        ...
        <motion.div className="space-y-12" variants={staggerContainer}>
          ...
          >
            <div className="space-y-4 text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed font-light">
              <p>{t("about.bio1")}</p>
              <p>{t("about.bio2")}</p>
            </div>

            {/* Location */}
            <div className="pt-6 text-sm text-gray-500 flex items-center justify-center gap-2">
